/* ================================================================
   ...
   Servizi (HD_SERVICES):
     HD1  Local   HD01 ↔ HD30  tutte le fermate  8 tph (headway 7.5 min)
                    Prima corsa SB: 05:12 da HD01
                    Prima corsa NB: 04:49 da HD30
                    Ultima corsa SB: 23:48 da HD01
                    Ultima corsa NB: 23:25 da HD30

   NOTE:
     — Servizio Rapid previsto in futuro; placeholder HD2 già
       predisposto in HD_SERVICES (commentato).
================================================================ */
'use strict';
...
const HD_LINES = {
  HD: {
    ...
    totalKm:       39.48,
    totalStations: 30,
    headwayPeak:    7.5,  // 8 tph
    headwayOffPeak: 7.5,  // servizio uniforme (Rapid futuro potrebbe differenziare)
    stations: [
...
const HD_SERVICES = [
  ...
  /* ──────────────────────────────────────────────────
     ...
     Decommentare e completare stops[] e peakWindows
     quando il servizio Rapid viene istituito.
  ────────────────────────────────────────────────── */
  // {
  //   id:       'HD2',
  //   desc:     'Rapid',
