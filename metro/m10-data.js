...
/* Ordine canonico geografico: M301 (nord) → M334 (sud)
   M3150 è inserito nella sua posizione geografica (tra M313 e M314),
   ma i servizi main-line lo saltano — solo i servizi LIM e SHO lo usano
   come capolinea. */
const M10_CANONICAL_ORDER = [
...
/* Ordine per il bramo M3150: parte da M3150, poi si innesta su M315 in avanti */
const M10_FROM_M3150 = [
...
/* ----------------------------------------------------------------
   Interscambi Metro Line 10 ↔ altre reti
---------------------------------------------------------------- */
const M10_INTERCHANGE = {
  M301: [
  ...
  M326: [
    ...
    { code: 'M1017', network: 'metro', transferMin: 3,
      note: 'Kansāri — M10 internal node' },
  ],
  M327: [
...
if (typeof module !== 'undefined') {
  module.exports = { M10_META, M10_ST, M10_CANONICAL_ORDER, M10_FROM_M3150, M10_INTERCHANGE };
}
